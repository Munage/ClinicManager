...
<html>
	...
	<body>
		<a href="#create-clinic" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-clinic" class="content scaffold-create" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${clinicInstance}" var="error">
