...
<html>
	...
	<body>
		<a href="#edit-medication" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-medication" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${medicationInstance?.version}" />
				<fieldset class="form">
