			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="title" title="${message(code: 'medication.title.label', default: 'Title')}" />
				...
				<g:each in="${medicationInstanceList}" status="i" var="medicationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${medicationInstance.id}">${fieldValue(bean: medicationInstance, field: "title")}</g:link></td>
